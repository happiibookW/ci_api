  ...
  /// fetch data against
       public function fetchOrder($compare,$table){
         ...
         $products=  $this->db->select('t1.*,t2.productName,t2.productPrice,t2.productdescription,t3.businessName,t4.userName,t4.profileImageUrl')
            ...
            $finalData[$i]['userProfileUrl']= ($this->checkFileInLaravel($list['profileImageUrl'])) ? 'https://hapiverse.com/hapiverse/public/' . $list['profileImageUrl'] : 'https://hapiverse.com/ci_api/public/' . $list['profileImageUrl'];
