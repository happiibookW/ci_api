                ...
                <div class="card invoice-preview-card">
                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            <div>
                                <div class="logo-wrapper">
                                    ...
                                    <h3 class="text-primary invoice-logo">Happiverse</h3>
                                </div>
                                <p class="card-text mb-25">Happiverse order recipt.</p>
                               
                            </div>
                            <div class="mt-md-0 mt-2">
                                <h4 class="invoice-title">
                                    Invoice
                                    <span class="invoice-number"><b>#<?php echo $business['orderNo']; ?></b></span>
                                </h4>
                                <div class="invoice-date-wrapper">
                                    <p class="invoice-date-title">Date Issued:</p>
                                    <p class="invoice-date"><?php echo dateformat($business['addDate']); ?></p>
                                </div>
                                <!-- <div class="invoice-date-wrapper">
                    ...
                    <div class="card-body invoice-padding pt-0">
                        <div class="row invoice-spacing">
                            <div class="col-xl-8 p-0">
                                <h6 class="mb-2">Shippment To:</h6>
                                <h6 class="mb-25"><?php echo $business['userName']; ?></h6>
                                <p class="card-text mb-25"><?php echo $business['shippingAddress'];  ?></p>
                            
                                <p class="card-text mb-25"><?php echo $business['userPhoneNo'] ?></p>
                                <p class="card-text mb-0"><?php echo $business['userEmail'] ?></p>
                            </div>
                            <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                <h6 class="mb-2">Shipped By :</h6>
                                <table>
                                    <tbody>
                                        <!-- <tr>
                                        ...
                                        <tr>
                                            <td class="pr-1">Business Name:</td>
                                            <td><?php echo $business['businessName'] ?></td>
                                        </tr>
                                        <tr>
                                            <td class="pr-1">Country:</td>
                                            <td><?php echo $business['businessCountry']; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="pr-1">Phone NO.:</td>
                                            <td><?php echo $business['businessContact'] ?></td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="py-1">Product Title</th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-1">
                                        <p class="card-text font-weight-bold mb-25"><?php echo $business['productName'] ?></p>
                                     
                                    </td>
                                    <td class="py-1">
                                        <span class="font-weight-bold"><?php echo $business['quantity'] ?></span>
                                    </td>
                                    <td class="py-1">
                                        <span class="font-weight-bold"><?php echo $business['orderCost'] ?></span>
                                    </td>
                            ...
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount"><?php echo CURRENCY.$business['orderCost'] ; ?></p>
                                    </div>
                                    <div class="invoice-total-item">
                                    ...
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount"><?php echo CURRENCY.$business['shippingCost'] ;   ?></p>
                                    </div>
                                    <hr class="my-50" />
                                    <div class="invoice-total-item">
                                        <p class="invoice-total-title">Total:</p>
                                        <p class="invoice-total-amount"><?php echo CURRENCY.$business['orderCost']+$business['shippingCost']  ; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
