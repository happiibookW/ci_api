                ...
                <div class="controls">
                            ...
                            <div class="inner">
                                ...
                                <div class="nav-drop-body is-friend-requests">
                                    ...
                                    <div class="media">
                                        <figure class="media-left">
                                            <p class="image">
                                                <img src="https://via.placeholder.com/150x150" data-demo-src="<?php echo base_url() ?>assets/img/avatars/edward.jpeg" data-user-popover="5" alt="">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                    ...
                                    <div class="media">
                                        <figure class="media-left">
                                            <p class="image">
                                                <img src="https://via.placeholder.com/150x150" data-demo-src="<?php echo base_url() ?>assets/img/avatars/dan.jpg" data-user-popover="1" alt="">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                            <a href="#">Dan Walker</a>
                    ...
                    <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                        <div class="user-image">
                            <img src="https://via.placeholder.com/400x400" data-demo-src="<?php echo base_url($profile->data->profileImageUrl) ?>" alt="">
                            <span class="indicator"></span>
                        </div>
                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                <div class="nav-drop-header">
                                    <span class="username"><?php echo $profile->data->userName ?></span>
                                ...
                                <div class="nav-drop-body account-items">
                                    <a id="profile-link" href="profile-main.html" class="account-item">
                                        <div class="media">
                                            ...
                                            <div class="media-content">
                                                <h3><?php echo $profile->data->userName ?></h3>
                                    ...
                                    <a class="account-item" href="<?php echo base_url().'index.php/Welcome/logout' ?>">
                                        <div class="media">
                                            <div class="icon-wrap">
