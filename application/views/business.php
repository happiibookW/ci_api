            ...
            <div class="columns is-multiline">
                ...
                <div class="column is-4">
                    <article class="group-box">
                        ...
                        <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/1.jpg"></div>
                        <a href="#" class="box-link">
                            <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/1.jpg"></div>
                        </a>
                        <div class="box-info">
                ...
                <div class="column is-4">
                    <article class="group-box">
                        ...
                        <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/2.jpg"></div>
                        <a href="#" class="box-link">
                            <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/2.jpg"></div>
                        </a>
                        <div class="box-info">
                ...
                <div class="column is-4">
                    <article class="group-box">
                        ...
                        <div class="box-img has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/3.jpg"></div>
                        <a href="#" class="box-link">
                            <div class="box-img--hover has-background-image" data-background="https://via.placeholder.com/940x650" data-demo-background="assets/img/demo/groups/3.jpg"></div>
                        </a>
                        <div class="box-info">
